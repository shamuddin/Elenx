        ...
        for (let i = 0; i < gridHeight; i++) {
            ...
            for (let j = 0; j < cols; j++) {
                ...
                if (idx < gridKeys.length) {
                    ...
                    if (val.includes("🟢") || val.includes("✅") || val.includes("Matched") || val.includes("CLEAN"))
                        valColor = "\x1b[38;5;76m";
                    if (val.includes("🚨") || val.includes("☣️") || val.includes("Drift") || val.includes("POISONED") || val.includes("HIJACKED") || val.includes("SCANNING") || val.includes("OFFLINE"))
                        valColor = "\x1b[38;5;196m";
