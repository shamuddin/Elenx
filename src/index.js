...
import { IdentityRegistry, TransactionalLedger, MissionControlUI, LineageGraph } from '@elenx/core';
...
export class ElenxKernel {
    ...
    auditLogPath = 'logs/audit.json';
    constructor(existingMcp) {
    ...
    async runAutonomousWorkflow(intent, url, selector, callerId = "system") {
